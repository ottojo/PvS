        ...
        MouseListener listMouseListener = new MouseListener() {
            ...
            public void mouseClicked(MouseEvent arg0) {
                if (arg0.getClickCount() == 2) {
                    ...
                    // Gruppe ändern mit EditGroupDialog

                    if (arg0.getSource() instanceof JList
                            && ((JList) arg0.getSource()).getSelectedValue() instanceof String
                            && ((JList) arg0.getSource()).getModel() instanceof DefaultListModel) {

                        JList currentGroupList = (JList) arg0.getSource();
                        String currentCountry = (String) currentGroupList.getSelectedValue();
                        DefaultListModel model = (DefaultListModel) currentGroupList.getModel();

                        EditGroupDialog e = new EditGroupDialog(CreateDialog.this, currentCountry);
                        e.addOnSuccessfulEditListener(newTitle -> model.set(currentGroupList.getSelectedIndex(), newTitle));
                        e.setVisible(true);
                    }
                }
            }
